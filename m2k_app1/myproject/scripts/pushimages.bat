...
:DEFAULT_REGISTRY
    ...
    SET REGISTRY_NAMESPACE=joseporres
	GOTO DOCKER_CONTAINER_RUNTIME
...
echo "pushing image legacy-java-application"
%CONTAINER_RUNTIME% tag legacy-java-application %REGISTRY_URL%/%REGISTRY_NAMESPACE%/legacy-java-application
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/legacy-java-application

echo "pushing image legacy-java-application-buildstage"
%CONTAINER_RUNTIME% tag legacy-java-application-buildstage %REGISTRY_URL%/%REGISTRY_NAMESPACE%/legacy-java-application-buildstage
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/legacy-java-application-buildstage
